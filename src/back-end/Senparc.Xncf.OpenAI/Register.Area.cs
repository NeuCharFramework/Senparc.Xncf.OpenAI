...
namespace Senparc.Xncf.OpenAI
{
                                    ...
                                    IXncfRazorRuntimeCompilation  //赋能 RazorPage 运行时编译
    {
        ...
        public IMvcBuilder AuthorizeConfig(IMvcBuilder builder, IHostEnvironment env)
        {
            ...
            SenparcTrace.SendCustomLog("OpenAI 启动", "完成 Area:Senparc.Xncf.OpenAI 注册");
        ...
        public string LibraryPath => Path.GetFullPath(Path.Combine(SiteConfig.WebRootPath, "..", "..", "Senparc.Xncf.OpenAI"));
        #endregion
    }
}
