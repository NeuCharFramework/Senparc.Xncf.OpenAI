...
namespace Senparc.Xncf.OpenAI.Models
{
    ...
    public class OpenAISenparcEntities_PostgreSQL : OpenAISenparcEntities
    {
        public OpenAISenparcEntities_PostgreSQL(DbContextOptions<OpenAISenparcEntities_PostgreSQL> dbContextOptions) : base(dbContextOptions)
        {
        }
    }
    ...
    /// </summary>
    public class SenparcDbContextFactory_PostgreSQL : SenparcDesignTimeDbContextFactoryBase<OpenAISenparcEntities_PostgreSQL, Register>
    {
