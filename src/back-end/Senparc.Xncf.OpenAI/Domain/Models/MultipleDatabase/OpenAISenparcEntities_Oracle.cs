...
namespace Senparc.Xncf.OpenAI.Models
{
    ...
    public class OpenAISenparcEntities_Oracle : OpenAISenparcEntities
    {
        public OpenAISenparcEntities_Oracle(DbContextOptions<OpenAISenparcEntities_Oracle> dbContextOptions) : base(dbContextOptions)
        {
        }
    }
    ...
    /// </summary>
    public class SenparcDbContextFactory_Oracle : SenparcDesignTimeDbContextFactoryBase<OpenAISenparcEntities_Oracle, Register>
    {
