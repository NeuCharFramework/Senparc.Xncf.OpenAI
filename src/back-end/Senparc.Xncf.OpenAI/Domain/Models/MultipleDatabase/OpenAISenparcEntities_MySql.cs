...
namespace Senparc.Xncf.OpenAI.Models
{
    ...
    public class OpenAISenparcEntities_MySql : OpenAISenparcEntities
    {
        public OpenAISenparcEntities_MySql(DbContextOptions<OpenAISenparcEntities_MySql> dbContextOptions) : base(dbContextOptions)
        {
        }
    }
    ...
    /// </summary>
    public class SenparcDbContextFactory_MySql : SenparcDesignTimeDbContextFactoryBase<OpenAISenparcEntities_MySql, Register>
    {
