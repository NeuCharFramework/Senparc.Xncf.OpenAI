...
namespace Senparc.Xncf.OpenAI.Models
{
    ...
    public class OpenAISenparcEntities_Sqlite : OpenAISenparcEntities
    {
        public OpenAISenparcEntities_Sqlite(DbContextOptions<OpenAISenparcEntities_Sqlite> dbContextOptions) : base(dbContextOptions)
        {
        }
    }
    ...
    /// </summary>
    public class SenparcDbContextFactory_Sqlite : SenparcDesignTimeDbContextFactoryBase<OpenAISenparcEntities_Sqlite, Register>
    {
