...
namespace Senparc.Xncf.OpenAI.Models
{
    ...
    public class OpenAISenparcEntities_SqlServer : OpenAISenparcEntities
    {
        public OpenAISenparcEntities_SqlServer(DbContextOptions<OpenAISenparcEntities_SqlServer> dbContextOptions) : base(dbContextOptions)
        {
        }
    }
    ...
    /// </summary>
    public class SenparcDbContextFactory_SqlServer : SenparcDesignTimeDbContextFactoryBase<OpenAISenparcEntities_SqlServer, Register>
    {
