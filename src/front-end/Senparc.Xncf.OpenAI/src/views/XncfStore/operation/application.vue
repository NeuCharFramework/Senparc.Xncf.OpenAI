            ...
            <div class="prepri">
              ...
              <el-card>
                ...
                <div v-if="prostate == true && whetherData == true" class="addArea">
                  ...
                  <div class="addAreain" @drag="menuDrag('defaultRhombus')" draggable="true">
                    <i class="icon-square"></i><strong>菱形模块</strong>
                  </div>
                ...
                <div class="process">
                  ...
                  <div v-if="prostate == true" class="editbig">
                    ...
                    <div class="styset">
                      <h2>默认样式</h2>
                      <div class="stysetin">
                        <el-button @click="changeNode('bluese')">蓝色</el-button>
                        <el-button @click="changeNode('orangese')">橙色</el-button>
                        <el-button @click="changeNode('grayse')">灰色</el-button>
                        <el-button @click="changeNode('greense')">绿色</el-button>
                        <el-button @click="changeNode('redse')">红色</el-button>
                      </div>
                      <h2>朴素样式</h2>
                      <div class="stysetin">
                        <el-button @click="changeNode('blueseplain')">蓝色</el-button>
                        <el-button @click="changeNode('orangeseplain')">橙色</el-button>
                        <el-button @click="changeNode('grayseplain')">灰色</el-button>
                        <el-button @click="changeNode('greenseplain')">绿色</el-button>
                        <el-button @click="changeNode('redseplain')">红色</el-button>
                      </div>
                    </div>
                    <h2>流程配置</h2>
                    <div class="cessout">
  ...
  data() {
    return {
      ...
      ruleForm: {
        ...
        //选择输入appid的方式 1.填写 2.选择上级输出 3.全局变量
        appIdradio: "1",
        appIdinput: "", //appid输入方式- 1.填写input
        appIdselect: "", //appid输入方式-2.选择上级输出
        appIdselectoptions: [
          {
            value: "value0.1.0",
            label: "value0.1.0",
        ...
        appIdselectoverall: "", //appid输入方式-3.全局变量
        overalloptions: [
          {
            value: "111value",
            label: "111value",
        ...
        //选择输入id的方式 1.填写 2.选择上级输出 3.全局变量
        Idradio: "2",
    ...
    changeNode(type, value) {
      ...
      switch (type) {
        case "labelText":
          ...
          break;
        case "bluese":
          this.selectCell.attr("label/fontSize", this.styles.bluese.fs); //字体大小
          this.selectCell.attr("label/fill", this.styles.bluese.color); //字体颜色
          this.selectCell.attr("body/fill", this.styles.bluese.bgc); //节点背景颜色
          this.selectCell.attr("body/stroke", this.styles.bluese.bordercolor); //边框颜色
          break;
        case "greense":
          this.selectCell.attr("label/fontSize", this.styles.greense.fs); //字体大小
          this.selectCell.attr("label/fill", this.styles.greense.color); //字体颜色
          this.selectCell.attr("body/fill", this.styles.greense.bgc); //节点背景颜色
          this.selectCell.attr("body/stroke", this.styles.greense.bordercolor); //边框颜色
          break;
        case "grayse":
          this.selectCell.attr("label/fontSize", this.styles.grayse.fs); //字体大小
          this.selectCell.attr("label/fill", this.styles.grayse.color); //字体颜色
          this.selectCell.attr("body/fill", this.styles.grayse.bgc); //节点背景颜色
          this.selectCell.attr("body/stroke", this.styles.grayse.bordercolor); //边框颜色
          break;
        case "orangese":
          this.selectCell.attr("label/fontSize", this.styles.orangese.fs); //字体大小
          this.selectCell.attr("label/fill", this.styles.orangese.color); //字体颜色
          this.selectCell.attr("body/fill", this.styles.orangese.bgc); //节点背景颜色
          this.selectCell.attr("body/stroke", this.styles.orangese.bordercolor); //边框颜色
          break;
        case "redse":
          this.selectCell.attr("label/fontSize", this.styles.redse.fs); //字体大小
          this.selectCell.attr("label/fill", this.styles.redse.color); //字体颜色
          this.selectCell.attr("body/fill", this.styles.redse.bgc); //节点背景颜色
          this.selectCell.attr("body/stroke", this.styles.redse.bordercolor); //边框颜色
          break;
        // 半透明
        case "blueseplain":
          this.selectCell.attr("label/fontSize", this.styles.blueseplain.fs); //字体大小
          this.selectCell.attr("label/fill", this.styles.blueseplain.color); //字体颜色
          this.selectCell.attr("body/fill", this.styles.blueseplain.bgc); //节点背景颜色
          this.selectCell.attr(
            "body/stroke",
            this.styles.blueseplain.bordercolor
          ); //边框颜色
          break;
        case "greenseplain":
          this.selectCell.attr("label/fontSize", this.styles.greenseplain.fs); //字体大小
          this.selectCell.attr("label/fill", this.styles.greenseplain.color); //字体颜色
          this.selectCell.attr("body/fill", this.styles.greenseplain.bgc); //节点背景颜色
          this.selectCell.attr(
            "body/stroke",
            this.styles.greenseplain.bordercolor
          ); //边框颜色
          break;
        case "grayseplain":
          this.selectCell.attr("label/fontSize", this.styles.grayseplain.fs); //字体大小
          this.selectCell.attr("label/fill", this.styles.grayseplain.color); //字体颜色
          this.selectCell.attr("body/fill", this.styles.grayseplain.bgc); //节点背景颜色
          this.selectCell.attr(
            "body/stroke",
            this.styles.grayseplain.bordercolor
          ); //边框颜色
          break;
        case "orangeseplain":
          this.selectCell.attr("label/fontSize", this.styles.orangeseplain.fs); //字体大小
          this.selectCell.attr("label/fill", this.styles.orangeseplain.color); //字体颜色
          this.selectCell.attr("body/fill", this.styles.orangeseplain.bgc); //节点背景颜色
          this.selectCell.attr(
            "body/stroke",
            this.styles.orangeseplain.bordercolor
          ); //边框颜色
          break;
        case "redseplain":
          this.selectCell.attr("label/fontSize", this.styles.redseplain.fs); //字体大小
          this.selectCell.attr("label/fill", this.styles.redseplain.color); //字体颜色
          this.selectCell.attr("body/fill", this.styles.redseplain.bgc); //节点背景颜色
          this.selectCell.attr(
            "body/stroke",
            this.styles.redseplain.bordercolor
          ); //边框颜色
          break;
      }
    },
