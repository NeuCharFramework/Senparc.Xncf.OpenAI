<template>
  <div>
    ...
    <div class="myapplicationall" v-if="!showmian">
      <!-- 标题 -->
      <el-card>
        <h3 class="shop-title">应用形式-微信API-SWAG文档</h3>
      </el-card>
      <!-- 推送素材 -->
      <el-card>
        <div class="notice">
                    ...
                    <table>
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>关闭</td>
                          <td>
                            <el-button type="primary" plain @click="showmian = true">查看详情</el-button>
    ...
    <div class="myapplication" v-if="showmian">
        ...
        <el-card>
          <div class="app-detail">
            ...
            <div class="app-detail-right">
              <el-descriptions class="margin-top" title="应用详情" :column="3" :size="size" border>
                ...
                <el-descriptions-item>
                  ...
                  <el-button style="margin-left: 5px" type="primary" plain @click="changeSwitch">切换</el-button>
                </el-descriptions-item>
                <el-descriptions-item>
                  <template slot="label">
                  ...
                  <el-button style="margin-left: 5px" type="primary" plain>打开高级设置</el-button>
                </el-descriptions-item>
                <el-descriptions-item>
                  <template slot="label">
                    <i class="el-icon-office-building"></i>
                  ...
                  <el-button v-if="appCodeState == false" style="margin-left: 5px" type="primary" plain
                             @click="getAppCode">获取AppCode</el-button>
      ...
      <div class="bottom">
        ...
        <el-table :data="tableData" style="width: 100%">
          ...
          <el-table-column prop="score" label="评分">
            <template>
              <div style="color: #5d9cec; cursor: pointer" @click="comment = true">
                添加评论
              </div>
            </template>
          </el-table-column>
      ...
      <!-- 添加评论 -->
      <div class="shop-comment" v-if="comment">
        ...
        <div>
          <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
            ...
            <span style="color: #ff902b; font-size: 15px">故意恶评或者刷分将被永久封号</span>
            <div class="operation">
    ...
    <!-- 推送素材 -->
    <el-dialog title="请选择需要推送的NeuChar Endings" :visible.sync="dialogVisible" width="60%" :before-close="handleClose">
      <el-card>
        <div class="pushState">
          <div class="dialogTit">
          ...
          <el-divider></el-divider>
          <el-table ref="multipleTable" :data="dialogTable" tooltip-effect="dark" style="width: 100%">
            <!-- <template slot-scope="scope">{{ scope.row.date }}</template> -->
            <el-table-column prop="name" label="NeuChar Endings">
            </el-table-column>
            <el-table-column prop="sqstate" label="授权状态" show-overflow-tooltip>
              <template slot-scope="scope">
...
.app-detail-right>>>.el-button--primary {
  padding: 5px;
}
